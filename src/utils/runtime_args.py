...
parser.add_argument('--graphs_folder', type=str, help='Specify the path to save the graphs.', default='./images/graph_folder/')
parser.add_argument('-e','--epoch', type=int, help='Specify the number of epochs for the training.', default=100)
parser.add_argument('-b','--batch_size', type=int, help='Specify the batch size to be used during training/testing.', default=10)
